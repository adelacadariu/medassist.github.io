<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Consultatii.aspx.cs" Inherits="licenta_test.Consultatii" %>
...
<body>
  ...
  <div id="linkScrisoare" runat="server">
    ...
    Scrisoare medicala
        ...
        <asp:BoundField DataField="ZiuaNasterii" HeaderText="Ziua Nașterii" />
        <asp:BoundField DataField="LunaNasterii" HeaderText="Luna Nașterii" />
        <asp:BoundField DataField="AnulNasterii" HeaderText="Anul Nașterii" />
        <asp:BoundField DataField="Profesie" HeaderText="Profesie" />
        <asp:BoundField DataField="LocMunca" HeaderText="Loc de Muncă" />
        ...
        <asp:BoundField DataField="Antecedente" HeaderText="Antecedente" />
        <asp:BoundField DataField="ConditiiDeMunca" HeaderText="Condiții de Muncă" />
        <asp:BoundField DataField="Simptome" HeaderText="Simptome" />
        <asp:BoundField DataField="Diagnostic" HeaderText="Diagnostic" />
        <asp:BoundField DataField="CodDiagnostic" HeaderText="Cod Diagnostic" />
        <asp:BoundField DataField="Recomandari" HeaderText="Recomandări" />
                                    </Columns>
                                </asp:GridView>
                             </div>
                        </div>
                  ...
                  <div class="form-group text-center">
                    <%--<asp:Button ID="Modify" runat="server" Text="Modificare pacient" type="submit" value="Modificare" class="btn btn-primary py-3 px-5" OnClick="ModificareDate_Click"/>--%>
                      <%--<asp:Button ID="Delete" runat="server" Text="Salvare modificari" type="submit" value="Salvare modificari" class="btn btn-primary py-3 px-5" OnClick="SalvareModificariPacient_Click"/>--%>
                  </div>
                </div>
                    </div>
