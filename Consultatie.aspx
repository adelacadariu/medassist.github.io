<%@ Page Language="C#" AutoEventWireup="true" Async="true" CodeBehind="Consultatie.aspx.cs" Inherits="licenta_test.Consultatie" %>
            ...
            <ul class="navbar-nav ms-auto">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item" href="#!">Iesire</a></li>
                    </ul>
                </li>
            </ul>
        </nav>
            ...
            <div id="layoutSidenav_content">
                  ...
                  <div class="form-group">
                    ...
                    <asp:TextBox runat="server" type="text" class="form-control" id="data" placeholder="Data emiterii retetei"/>
                      ...
                      <h3 class="mb-4"><br><br></h3>
                        <h1 align="center" class="mt-4">Fisa de consultatii medicale</h1>
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <label for="">Varsta</label>
                      ...
                      <div class="col-md-6">
                  <div class="form-group">
                    <label for="">Ziua nasterii</label>
					  <asp:TextBox id="ZiuaNastere" runat="server" type="text" class="form-control" placeholder="Ziua nasterii pacientului" />
                  ...
                  <div class="form-group">
                    <label for="">Profesie</label>
                      ...
                      <div class="col-md-6">
                  <div class="form-group">
                    <label for="">Luna nasterii</label>
					  <asp:TextBox id="LunaNastere" runat="server" type="text" class="form-control" placeholder="Luna nasterii pacientului" />
                  ...
                  <div class="form-group">
                    <label for="">Anul nasterii</label>
					  <asp:TextBox id="AnNastere" runat="server" type="text" class="form-control" placeholder="Anul nasterii pacientului" />
                  ...
                  <div class="form-group">
                    <label for="">Antecedente</label>
					  <asp:TextBox id="Antecedente" runat="server" type="text" class="form-control" placeholder="Antecedente" />
                    
                  </div>
                </div>
                      <div class="col-md-6">
                  <div class="form-group">
                    <label for="">Conditii de munca</label>
					  <asp:TextBox id="ConditiiDeMunca" runat="server" type="text" class="form-control" placeholder="Conditii de munca" />
                      ...
                      <div class="col-md-6">
                  <div class="form-group">
                    <label for="">Simptome</label>
					  <asp:TextBox id="Simptome" runat="server" type="text" class="form-control" placeholder="Simptomele prezentate" />
                  ...
                  <div class="form-group">
                    <label for="">Diagnostic</label>
                      ...
                      <div class="col-md-6">
                  <div class="form-group">
                    <label for="">Codul</label>
					  <asp:TextBox id="Cod" runat="server" type="text" class="form-control" placeholder="Codul diagnosticului" />
                    
                  </div>
                </div>
                      <div class="col-md-6">
                  <div class="form-group">
                    <label for="">Recomandari</label>
					  <asp:TextBox id="Recomandari" runat="server" type="text" class="form-control" placeholder="Recomandarile medicului" />
                ...
                <div class="col-md-12 mt-3">
                  <div class="form-group text-center">
                    <asp:Button ID="SubmitConsultatie" runat="server" Text="Salvare consultatie" type="submit" value="Salvare consultatie" class="btn btn-primary py-3 px-5" OnClick="SalvareConsultatie_Click"/>
                  </div>
                </div>
	              </div>
	            </form>
